  ...
  module GptImage
    module Resources
      ...
      class Edits
        ...
        ENDPOINT = "/api/v1/gpt_image/edits"

        RESPONSE_CLASS = Types::EditResponse
        COMPLETED_RESPONSE_CLASS = Types::CompletedEditResponse
        ...
        # @return [RunApi::GptImage::Types::CompletedEditResponse] completed edit with images
        def run(**params)
          task = create(**params)
        ...
        #
        # @param params [Hash] edit parameters
        # @return [RunApi::GptImage::Types::EditResponse] task creation result with id
        def create(**params)
        ...
        # @return [RunApi::GptImage::Types::EditResponse] current edit status
        def get(id)
